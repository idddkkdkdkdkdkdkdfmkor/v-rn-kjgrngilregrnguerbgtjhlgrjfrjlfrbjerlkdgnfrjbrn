    ...
    <div className="min-h-screen bg-white pt-24 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-mint border border-brand-mint text-brand-dark text-sm font-semibold mb-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#0F172A] leading-[1.1] tracking-tight mb-6">
            Identity Solutions Built for Schools with <span className="text-brand-primary">Multiple Branches.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-brand-primary hover:bg-brand-dark text-white rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-2xl border border-slate-200 text-center hover:border-blue-300 hover:shadow-md transition-all">
                <div className="w-12 h-12 rounded-xl bg-brand-mint text-brand-primary flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <div className="mt-1 bg-brand-mint p-1 rounded-full text-brand-primary">
          ...
          <div className="bg-slate-100 rounded-3xl p-8 border border-slate-200 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-brand-mint0/10 to-transparent"></div>
            <img 
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between relative">
          <div className="hidden md:block absolute top-1/2 left-0 w-full h-1 bg-brand-mint -translate-y-1/2 z-0"></div>
          {[
            ...
            <div key={i} className="relative z-10 flex flex-col items-center text-center max-w-[200px] mb-8 md:mb-0">
              <div className="w-12 h-12 rounded-full bg-brand-primary text-white font-bold text-xl flex items-center justify-center mb-4 border-4 border-white shadow-lg">
                {item.step}
              </div>
